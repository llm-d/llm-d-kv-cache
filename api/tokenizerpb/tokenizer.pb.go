...
// Content is either a plain string (content) or a list of multimodal parts (content_parts).
type ChatMessage struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Role          string                 `protobuf:"bytes,1,opt,name=role,proto3" json:"role,omitempty"`                                     // Role of the message (e.g., "user", "assistant", "system")
	Content       *string                `protobuf:"bytes,2,opt,name=content,proto3,oneof" json:"content,omitempty"`                         // Plain-text content
	ContentParts  []*ContentPart         `protobuf:"bytes,3,rep,name=content_parts,json=contentParts,proto3" json:"content_parts,omitempty"` // Multimodal content parts (set when content is null)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type RenderChatCompletionRequest struct {
	...
	Tools                []*ToolDescription     `protobuf:"bytes,3,rep,name=tools,proto3" json:"tools,omitempty"`                                                                                                                                 // Tools available to the model
	...
	ContinueFinalMessage bool                   `protobuf:"varint,6,opt,name=continue_final_message,json=continueFinalMessage,proto3" json:"continue_final_message,omitempty"`                                                                    // Whether to continue the final message
	ChatTemplateKwargs   map[string]*Value      `protobuf:"bytes,7,rep,name=chat_template_kwargs,json=chatTemplateKwargs,proto3" json:"chat_template_kwargs,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // Additional chat template arguments
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
const file_api_tokenizerpb_tokenizer_proto_rawDesc = "" +
	...
	"\bmessages\x18\x02 \x03(\v2\x19.tokenization.ChatMessageR\bmessages\x123\n" +
	"\x05tools\x18\x03 \x03(\v2\x1d.tokenization.ToolDescriptionR\x05tools\x12#\n" +
	"\rchat_template\x18\x04 \x01(\tR\fchatTemplate\x122\n" +
	"\x15add_generation_prompt\x18\x05 \x01(\bR\x13addGenerationPrompt\x124\n" +
	"\x16continue_final_message\x18\x06 \x01(\bR\x14continueFinalMessage\x12s\n" +
	"\x14chat_template_kwargs\x18\a \x03(\v2A.tokenization.RenderChatCompletionRequest.ChatTemplateKwargsEntryR\x12chatTemplateKwargs\x1aZ\n" +
	"\x17ChatTemplateKwargsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12)\n" +
	...
	"\x06prompt\x18\x02 \x01(\tR\x06prompt\"\x9b\x01\n" +
...
var file_api_tokenizerpb_tokenizer_proto_msgTypes = make([]protoimpl.MessageInfo, 30)
var file_api_tokenizerpb_tokenizer_proto_goTypes = []any{
	...
	nil,                                  // 29: tokenization.RenderChatCompletionRequest.ChatTemplateKwargsEntry
}
var file_api_tokenizerpb_tokenizer_proto_depIdxs = []int32{
	...
	7,  // 17: tokenization.RenderChatCompletionRequest.tools:type_name -> tokenization.ToolDescription
	29, // 18: tokenization.RenderChatCompletionRequest.chat_template_kwargs:type_name -> tokenization.RenderChatCompletionRequest.ChatTemplateKwargsEntry
	18, // 19: tokenization.RenderChatCompletionResponse.features:type_name -> tokenization.MultiModalFeatures
	20, // 20: tokenization.RenderCompletionResponse.items:type_name -> tokenization.RenderChatCompletionResponse
	9,  // 21: tokenization.ChatTemplateRequest.ChatTemplateKwargsEntry.value:type_name -> tokenization.Value
	9,  // 22: tokenization.ToolDescription.ToolEntry.value:type_name -> tokenization.Value
	9,  // 23: tokenization.Document.DocumentEntry.value:type_name -> tokenization.Value
	9,  // 24: tokenization.StructValue.FieldsEntry.value:type_name -> tokenization.Value
	16, // 25: tokenization.MultiModalFeatures.MmHashesEntry.value:type_name -> tokenization.StringList
	17, // 26: tokenization.MultiModalFeatures.MmPlaceholdersEntry.value:type_name -> tokenization.PlaceholderRangeList
	9,  // 27: tokenization.RenderChatCompletionRequest.ChatTemplateKwargsEntry.value:type_name -> tokenization.Value
	...
	13, // 30: tokenization.TokenizationService.InitializeTokenizer:input_type -> tokenization.InitializeTokenizerRequest
	19, // 31: tokenization.TokenizationService.RenderChatCompletion:input_type -> tokenization.RenderChatCompletionRequest
	21, // 32: tokenization.TokenizationService.RenderCompletion:input_type -> tokenization.RenderCompletionRequest
	1,  // 33: tokenization.TokenizationService.Tokenize:output_type -> tokenization.TokenizeResponse
	12, // 34: tokenization.TokenizationService.RenderChatTemplate:output_type -> tokenization.ChatTemplateResponse
	14, // 35: tokenization.TokenizationService.InitializeTokenizer:output_type -> tokenization.InitializeTokenizerResponse
	20, // 36: tokenization.TokenizationService.RenderChatCompletion:output_type -> tokenization.RenderChatCompletionResponse
	22, // 37: tokenization.TokenizationService.RenderCompletion:output_type -> tokenization.RenderCompletionResponse
