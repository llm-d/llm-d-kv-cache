...
// CompletionResult holds the rendered output for a single prompt in a batch.
...
func (x *CompletionResult) GetRequestId() string {
	if x != nil {
		return x.RequestId
	}
	return ""
...
func (x *CompletionResult) GetTokenIds() []uint32 {
	if x != nil {
		return x.TokenIds
	}
	return nil
...
// RenderBatchCompletionRequest renders multiple prompts in a single call.
type RenderBatchCompletionRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *RenderBatchCompletionRequest) Reset() {
	*x = RenderBatchCompletionRequest{}
	mi := &file_api_tokenizerpb_tokenizer_proto_msgTypes[24]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *RenderBatchCompletionRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RenderBatchCompletionRequest) ProtoMessage() {}

func (x *RenderBatchCompletionRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_tokenizerpb_tokenizer_proto_msgTypes[24]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RenderBatchCompletionRequest.ProtoReflect.Descriptor instead.
func (*RenderBatchCompletionRequest) Descriptor() ([]byte, []int) {
	return file_api_tokenizerpb_tokenizer_proto_rawDescGZIP(), []int{24}
}

func (x *RenderBatchCompletionRequest) GetModelName() string {
	if x != nil {
		return x.ModelName
	}
	return ""
...
func (x *RenderBatchCompletionRequest) GetPrompts() []string {
	if x != nil {
		return x.Prompts
	}
	return nil
...
// RenderBatchCompletionResponse returns per-prompt results.
type RenderBatchCompletionResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Results       []*CompletionResult    `protobuf:"bytes,1,rep,name=results,proto3" json:"results,omitempty"`
...
func (x *RenderBatchCompletionResponse) Reset() {
	*x = RenderBatchCompletionResponse{}
	mi := &file_api_tokenizerpb_tokenizer_proto_msgTypes[25]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *RenderBatchCompletionResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RenderBatchCompletionResponse) ProtoMessage() {}

func (x *RenderBatchCompletionResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_tokenizerpb_tokenizer_proto_msgTypes[25]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RenderBatchCompletionResponse.ProtoReflect.Descriptor instead.
func (*RenderBatchCompletionResponse) Descriptor() ([]byte, []int) {
	return file_api_tokenizerpb_tokenizer_proto_rawDescGZIP(), []int{25}
}

func (x *RenderBatchCompletionResponse) GetResults() []*CompletionResult {
	if x != nil {
		return x.Results
	}
	return nil
...
func (x *RenderBatchCompletionResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *RenderBatchCompletionResponse) GetErrorMessage() string {
	if x != nil {
		return x.ErrorMessage
	}
	return ""
...
const file_api_tokenizerpb_tokenizer_proto_rawDesc = "" +
	...
	"\x10CompletionResult\x12\x1d\n" +
	"\n" +
	"request_id\x18\x01 \x01(\tR\trequestId\x12\x1b\n" +
	"\ttoken_ids\x18\x02 \x03(\rR\btokenIds\"W\n" +
	"\x1cRenderBatchCompletionRequest\x12\x1d\n" +
	"\n" +
	"model_name\x18\x01 \x01(\tR\tmodelName\x12\x18\n" +
	"\aprompts\x18\x02 \x03(\tR\aprompts\"\x98\x01\n" +
	"\x1dRenderBatchCompletionResponse\x128\n" +
	"\aresults\x18\x01 \x03(\v2\x1e.tokenization.CompletionResultR\aresults\x12\x18\n" +
	"\asuccess\x18\x02 \x01(\bR\asuccess\x12#\n" +
	"\rerror_message\x18\x03 \x01(\tR\ferrorMessage2\xed\x04\n" +
	...
	"\x10RenderCompletion\x12%.tokenization.RenderCompletionRequest\x1a&.tokenization.RenderCompletionResponse\x12p\n" +
	"\x15RenderBatchCompletion\x12*.tokenization.RenderBatchCompletionRequest\x1a+.tokenization.RenderBatchCompletionResponseB=Z;github.com/llm-d/llm-d-kv-cache/api/tokenizerpb;tokenizerpbb\x06proto3"
...
var file_api_tokenizerpb_tokenizer_proto_goTypes = []any{
	...
	(*CompletionResult)(nil),              // 23: tokenization.CompletionResult
	(*RenderBatchCompletionRequest)(nil),  // 24: tokenization.RenderBatchCompletionRequest
	(*RenderBatchCompletionResponse)(nil), // 25: tokenization.RenderBatchCompletionResponse
...
var file_api_tokenizerpb_tokenizer_proto_depIdxs = []int32{
	...
	27, // 7: tokenization.ToolDescription.tool:type_name -> tokenization.ToolDescription.ToolEntry
	28, // 8: tokenization.Document.document:type_name -> tokenization.Document.DocumentEntry
	...
	29, // 12: tokenization.StructValue.fields:type_name -> tokenization.StructValue.FieldsEntry
	15, // 13: tokenization.PlaceholderRangeList.ranges:type_name -> tokenization.PlaceholderRange
	30, // 14: tokenization.MultiModalFeatures.mm_hashes:type_name -> tokenization.MultiModalFeatures.MmHashesEntry
	31, // 15: tokenization.MultiModalFeatures.mm_placeholders:type_name -> tokenization.MultiModalFeatures.MmPlaceholdersEntry
	...
	23, // 18: tokenization.RenderBatchCompletionResponse.results:type_name -> tokenization.CompletionResult
	9,  // 19: tokenization.ChatTemplateRequest.ChatTemplateKwargsEntry.value:type_name -> tokenization.Value
	9,  // 20: tokenization.ToolDescription.ToolEntry.value:type_name -> tokenization.Value
	9,  // 21: tokenization.Document.DocumentEntry.value:type_name -> tokenization.Value
	9,  // 22: tokenization.StructValue.FieldsEntry.value:type_name -> tokenization.Value
	16, // 23: tokenization.MultiModalFeatures.MmHashesEntry.value:type_name -> tokenization.StringList
	17, // 24: tokenization.MultiModalFeatures.MmPlaceholdersEntry.value:type_name -> tokenization.PlaceholderRangeList
	0,  // 25: tokenization.TokenizationService.Tokenize:input_type -> tokenization.TokenizeRequest
	3,  // 26: tokenization.TokenizationService.RenderChatTemplate:input_type -> tokenization.ChatTemplateRequest
	13, // 27: tokenization.TokenizationService.InitializeTokenizer:input_type -> tokenization.InitializeTokenizerRequest
	19, // 28: tokenization.TokenizationService.RenderChatCompletion:input_type -> tokenization.RenderChatCompletionRequest
	21, // 29: tokenization.TokenizationService.RenderCompletion:input_type -> tokenization.RenderCompletionRequest
	24, // 30: tokenization.TokenizationService.RenderBatchCompletion:input_type -> tokenization.RenderBatchCompletionRequest
	1,  // 31: tokenization.TokenizationService.Tokenize:output_type -> tokenization.TokenizeResponse
	12, // 32: tokenization.TokenizationService.RenderChatTemplate:output_type -> tokenization.ChatTemplateResponse
	14, // 33: tokenization.TokenizationService.InitializeTokenizer:output_type -> tokenization.InitializeTokenizerResponse
	20, // 34: tokenization.TokenizationService.RenderChatCompletion:output_type -> tokenization.RenderChatCompletionResponse
	22, // 35: tokenization.TokenizationService.RenderCompletion:output_type -> tokenization.RenderCompletionResponse
	25, // 36: tokenization.TokenizationService.RenderBatchCompletion:output_type -> tokenization.RenderBatchCompletionResponse
