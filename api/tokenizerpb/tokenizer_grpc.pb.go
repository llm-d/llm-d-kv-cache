...
const (
	...
	TokenizationService_RenderBatchCompletion_FullMethodName = "/tokenization.TokenizationService/RenderBatchCompletion"
)
...
type TokenizationServiceClient interface {
	...
	RenderBatchCompletion(ctx context.Context, in *RenderBatchCompletionRequest, opts ...grpc.CallOption) (*RenderBatchCompletionResponse, error)
}
...
func (c *tokenizationServiceClient) RenderBatchCompletion(ctx context.Context, in *RenderBatchCompletionRequest, opts ...grpc.CallOption) (*RenderBatchCompletionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RenderBatchCompletionResponse)
	err := c.cc.Invoke(ctx, TokenizationService_RenderBatchCompletion_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TokenizationServiceServer interface {
	...
	// RenderBatchCompletion renders multiple OpenAI completion requests in a single call,
	// returning per-prompt token IDs via OpenAIServingRender
	RenderBatchCompletion(context.Context, *RenderBatchCompletionRequest) (*RenderBatchCompletionResponse, error)
...
func (UnimplementedTokenizationServiceServer) RenderBatchCompletion(context.Context, *RenderBatchCompletionRequest) (*RenderBatchCompletionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RenderBatchCompletion not implemented")
}
...
func _TokenizationService_RenderBatchCompletion_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RenderBatchCompletionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TokenizationServiceServer).RenderBatchCompletion(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TokenizationService_RenderBatchCompletion_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TokenizationServiceServer).RenderBatchCompletion(ctx, req.(*RenderBatchCompletionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TokenizationService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RenderBatchCompletion",
			Handler:    _TokenizationService_RenderBatchCompletion_Handler,
		},
	},
