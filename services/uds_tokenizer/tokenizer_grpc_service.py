...
class TokenizationServiceServicer(tokenizer_pb2_grpc.TokenizationServiceServicer):
    ...
    def __init__(self):
        self.model_to_key_map = {}  # Dictionary to store model name to tokenizer key mapping
    ...
    def Render(self, request, context):
        ...
        try:
            ...
            if model_name not in self.model_to_key_map:
                # Model not initialized, return failure response
            ...
            tokenizer_key = self.model_to_key_map[model_name]
    ...
    def InitializeTokenizer(self, request, context):
        ...
        try:
            ...
            if model_name in self.model_to_key_map:
            ...
            self.model_to_key_map[model_name] = tokenizer_key
...
def create_grpc_server(uds_socket_path: str, thread_pool):
